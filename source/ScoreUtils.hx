...
class ScoreUtils
{
	...
	public static var gradeConditions:Map<Int, String> = [
		100 => "☆☆☆☆", 99 => "☆☆☆", 98 => "☆☆", 96 => "☆", 94 => "S+", 92 => "S", 89 => "S-", 86 => "A+", 83 => "A", 80 => "A-", 76 => "B+", 72 => "B",
		68 => "B-", 64 => "C+", 60 => "C", 55 => "C-", 50 => "D+", 45 => "D",
	];
	...
	public static function malewife(noteDiff:Float, timeScale:Float = 1):Float
	{ // https://github.com/etternagame/etterna/blob/0a7bd768cffd6f39a3d84d76964097e43011ce33/src/RageUtil/Utils/RageUtil.h
		var jPow:Float = 0.75;
	...
	public static function GetMaxAccuracy(noteCounters:Map<String, Int>):Float
	{ // ITG-like system
		var points:Float = 0;
