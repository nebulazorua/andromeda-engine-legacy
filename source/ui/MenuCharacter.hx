...
class MenuCharacter extends FlxSprite
{
	...
	private static var settings:Map<String, MenuCharData> = [
		...
		'dad' => {
			name: "Dad idle dance BLACK LINE",
			xOffset: 0,
			yOffset: 0,
			scale: .5,
			fps: 24,
		...
		'spooky' => {
			name: "spooky dance idle BLACK LINES",
			xOffset: 0,
			yOffset: 90,
			scale: .5,
			fps: 24,
