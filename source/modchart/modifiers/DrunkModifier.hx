...
class DrunkModifier extends Modifier
{
	...
	{
		return [
			"tipsy", "bumpy", "drunkSpeed", "drunkOffset", "drunkPeriod", "tipsySpeed", "tipsyOffset", "bumpyOffset", "bumpyPeriod", "tipZ", "tipZSpeed",

			"tipZOffset", "drunkZ", "drunkZSpeed", "drunkZOffset", "drunkZPeriod"
