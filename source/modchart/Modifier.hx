...
class Modifier
{
	...
	public function getReceptorScale(receptor:Receptor, scale:FlxPoint, data:Int, player:Int)
		return scale;

	public function getNoteScale(note:Note, scale:FlxPoint, data:Int, player:Int)
		return scale;
	...
	public function getPath(visualDiff:Float, pos:Vector3, data:Int, player:Int, timeDiff:Float)
		return pos;
}
